...
| Line | Meaning |
|------|---------|
| `000000000000004` | 4 DEVELOPER records with SALARY >= 004500 (IVANOV 005000, KOZLOV 004500, NOVIKOV 006100, SOKOLOV 005500) |
| `000000000000003` | 3 MANAGER records with SALARY >= 006000 (SIDOROV 007800, POPOV 008200, LEBEDEV 006800) |
