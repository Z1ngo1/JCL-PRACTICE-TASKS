...
- `DELETE 5` in SYSOUT means 5 records were dropped by the INCLUDE filter - JOHNSON (X/NY), WILLIAMS (A/CA), JONES (X/TX), MILLER (A/FL), WILSON (X/NY). Either wrong type or wrong state.
